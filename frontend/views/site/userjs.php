...
*/
//Only token server
$tokenUrl=Yii::$app->params['publicURI']['token'];
$syncVersion=Yii::$app->params['fxaVersions']['SyncVersion'];
$protocoleVersion=Yii::$app->params['fxaVersions']['ProtocoleVersion'];
?>
user_pref("identity.sync.tokenserver.uri","<?=$tokenUrl?>/<?=$syncVersion?>/sync/<?=$protocoleVersion?>");
